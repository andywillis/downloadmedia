...
Modified icons from <a href="https://www.flaticon.com/free-icons/jpg" title="jpg icons">Jpg icons created by Dimitry Miroliubov - Flaticon</a>. There are six sets of icons. Each icon set has both a 16 pixel and a 32 pixel PNG image, and is one of six colours. Red, yellow, green, purple, blue, and gray.
